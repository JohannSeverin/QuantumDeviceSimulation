...
class SimulationExperiment:
    ...
    """
    def __init__(self, system, times, states, expectation_operators = None, store_states = False, only_store_final = False, save_path = None):
    ...
    def run_single_experiment(self):
        ...
        if self.number_of_states == 1:
            ...
            if self.expectation_operators:
                results["exp_vals"]     = self.exp_vals(simulation_result.states, self.expectation_operators)
    ...
    def run_double_sweep(self):
        ...
        for value_outer in outer[2]:
            ...
            inner_sweep_results = {key: [] for key in results if key in ["states", "exp_vals"]}
